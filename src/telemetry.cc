...
namespace jlb
{
    ...
    private:
        ...
        void upd_timer_callback()
        {
            ...
            if (bytes_received > 0)
            {
                // the last 4 bytes are the timestamp in motorola format
                uint32_t timestamp = 0;
                timestamp |= static_cast<uint8_t>(data[bytes_received - 4]) << 24;
                timestamp |= static_cast<uint8_t>(data[bytes_received - 3]) << 16;
                timestamp |= static_cast<uint8_t>(data[bytes_received - 2]) << 8;
                timestamp |= static_cast<uint8_t>(data[bytes_received - 1]);

                auto idx = 0;
                while (idx < bytes_received - 4)
                {
                    ...
                    switch (received_id)
                    {
                        case measurements_1_CANID:
                        {
                            ...
                            measurements1_msg.timestamp      = timestamp;
                        ...
                        case measurements_2_CANID:
                        {
                            ...
                            measurements2_msg.timestamp      = timestamp;
                        ...
                        case measurements_3_CANID:
                        {
                            ...
                            measurements3_msg.timestamp          = timestamp;
                        ...
                        case measurements_4_CANID:
                        {
                            ...
                            measurements4_msg.timestamp             = timestamp;
                        ...
                        case measurements_5_CANID:
                        {
                            ...
                            measurements5_msg.timestamp     = timestamp;
                        ...
                        case odometry_1_CANID:
                        {
                            ...
                            odometry1_msg.timestamp   = timestamp;
                        ...
                        case odometry_2_CANID:
                        {
                            ...
                            odometry2_msg.timestamp          = timestamp;
                        ...
                        case logic_1_CANID:
                        {
                            ...
                            logic1_msg.timestamp         = timestamp;
                        ...
                        case logic_2_CANID:
                        {
                            ...
                            logic2_msg.timestamp         = timestamp;
                        ...
                        case logic_3_CANID:
                        {
                            ...
                            logic3_msg.timestamp           = timestamp;
